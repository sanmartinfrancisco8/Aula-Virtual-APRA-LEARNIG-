    ...
    <div className="space-y-8 animate-in fade-in duration-500">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-gray-300 text-sm mt-1">Accede a tus clases síncronas y reuniones de videoconferencia</p>
        </div>
      </div>
      ...
      <div className="bg-slate-950/40 backdrop-blur-md border border-white/10 rounded-xl p-6 shadow-2xl relative overflow-hidden">
        <div className="text-center py-12 text-gray-400">
          <Video size={48} className="mx-auto mb-4 text-blue-500/50" />
          <p>Módulo de sala virtual en construcción</p>
        </div>
      </div>
    </div>
  );
